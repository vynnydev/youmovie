...
<h1 align="center">
  <img alt="Layout" src="./github/main-image/logo/youmovie.png">
</h1>
<br/>
<h1 align="center">
  <img alt="Layout" src="./github/main-image/gif/youmovie-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the YouMovie project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for YouMovie project
</h3>
...
<p align="center">YouMovie - Your movies and your series are all here!</p>

This api is manage YouMovie app, developed with Typescript, NodeJs, Express, TypeORM, Postgres e JWT.
...
```bash
$ git clone https://github.com/vynnydev/youmovie.git && cd youmovie
...
$ gh repo fork vynnydev/youmovie
```
...
```bash
# Clone your fork
$ git clone your-fork-url && cd youmovie
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for YouMovie project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/youmovie-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/youmovie-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/reset-password/youmovie-reset-password.png">
</p>
...
<h3 align="center">
  React Native Application for YouMovie project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/youmovie-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/vynnydev/youhealth_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/vynnydev/youmovie.git && cd youmovie_mob
OR 
$ git clone https://github.com/vynnydev/youmovie_mobile.git
...
$ gh repo fork vynnydev/youmovie_mobile
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd youmovie_mobile
